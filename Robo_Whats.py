...
def run(playwright: Playwright) -> None:
    ...
    print("Valide o QRCode em seu Aparelo")
    ...
    for i, DADOS in enumerate(Sheet1_df['Nome']):
        ...
        Menssagem =Sheet1_df.loc[i,"Menssagem"]

        print(Nome,Telefone,Menssagem)
        ##exit()
        page.wait_for_timeout(13000)
        ...
        try:
            ...
            with page.expect_navigation(50):# aguarda o elemento por 30 segundos por padrão
